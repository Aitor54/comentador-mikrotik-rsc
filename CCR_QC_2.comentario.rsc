...
##########          CCR2004-16G-2S+ (Identity: Desconocido)            ###############
################################################################################
# Analizando dispositivo... (Contexto Operacional N4)
# Integridad 1:1 garantizada. Configuración agrupada para legibilidad.

# 2026-01-29 10:19:08 by RouterOS 7.20.8
# software id = 5NYP-7WFV
#
# model = CCR2004-16G-2S+
# serial number = HH90AFG4EQ1
...
add keepalive=1s,3 local-address=172.19.10.241 loop-protect=off mac-address=\
    FE:4B:20:80:45:54 name=IF-EOIP-2011-QC10 remote-address=172.19.10.242 \
    tunnel-id=101
add keepalive=1s,3 local-address=172.19.11.241 loop-protect=off mac-address=\
    FE:E7:EE:34:30:A2 name=IF-EOIP-2011-QC11 remote-address=172.19.11.242 \
    tunnel-id=111
add keepalive=1s,3 local-address=172.19.12.241 loop-protect=off mac-address=\
    FE:D2:1D:DB:6E:FB name=IF-EOIP-2011-QC12 remote-address=172.19.12.242 \
    tunnel-id=121
add keepalive=1s,3 local-address=172.19.14.241 loop-protect=off mac-address=\
    FE:E4:02:6F:32:7E name=IF-EOIP-2011-QC14 remote-address=172.19.14.242 \
    tunnel-id=141
add keepalive=1s,3 local-address=172.19.15.241 loop-protect=off mac-address=\
    FE:58:86:DF:C3:93 name=IF-EOIP-2011-QC15 remote-address=172.19.15.242 \
    tunnel-id=151
add keepalive=1s,3 local-address=172.19.16.241 loop-protect=off mac-address=\
    FE:C2:AA:E8:2F:3E name=IF-EOIP-2011-QC16 remote-address=172.19.16.242 \
    tunnel-id=161
add keepalive=1s,3 local-address=172.19.17.241 loop-protect=off mac-address=\
    FE:B4:B7:82:A1:3F name=IF-EOIP-2011-QC17 remote-address=172.19.17.242 \
    tunnel-id=171
add keepalive=1s,3 local-address=172.19.18.241 loop-protect=off mac-address=\
    FE:0F:C8:57:9A:6B name=IF-EOIP-2011-QC18 remote-address=172.19.18.242 \
    tunnel-id=181
add keepalive=1s,3 local-address=172.19.19.241 loop-protect=off mac-address=\
    FE:D8:10:37:ED:1B name=IF-EOIP-2011-QC19 remote-address=172.19.19.242 \
    tunnel-id=191
add keepalive=1s,3 local-address=172.19.20.241 loop-protect=off mac-address=\
    FE:19:55:B2:56:3C name=IF-EOIP-2011-QC20 remote-address=172.19.20.242 \
    tunnel-id=201
add keepalive=1s,3 local-address=172.19.21.241 loop-protect=off mac-address=\
    FE:2E:16:A2:0F:E6 name=IF-EOIP-2011-QC21 remote-address=172.19.21.242 \
    tunnel-id=211
add keepalive=1s,3 local-address=172.19.22.241 loop-protect=off mac-address=\
    FE:63:34:A0:EA:64 name=IF-EOIP-2011-QC22 remote-address=172.19.22.242 \
    tunnel-id=221
add keepalive=1s,3 local-address=172.19.23.241 loop-protect=off mac-address=\
    FE:57:57:BC:11:15 name=IF-EOIP-2011-QC23 remote-address=172.19.23.242 \
    tunnel-id=231
add keepalive=1s,3 local-address=172.19.24.241 loop-protect=off mac-address=\
    FE:19:23:C0:BF:01 name=IF-EOIP-2011-QC24 remote-address=172.19.24.242 \
    tunnel-id=241
add keepalive=1s,3 local-address=172.19.25.241 loop-protect=off mac-address=\
    FE:2F:0C:E5:70:17 name=IF-EOIP-2011-QC25 remote-address=172.19.25.242 \
    tunnel-id=251
add keepalive=1s,3 local-address=172.19.26.241 loop-protect=off mac-address=\
    FE:9B:61:C3:AA:69 name=IF-EOIP-2011-QC26 remote-address=172.19.26.242 \
    tunnel-id=261
add keepalive=1s,3 local-address=172.19.27.241 loop-protect=off mac-address=\
    FE:63:28:39:57:63 name=IF-EOIP-2011-QC27 remote-address=172.19.27.242 \
    tunnel-id=271
add keepalive=1s,3 local-address=172.19.28.241 loop-protect=off mac-address=\
    FE:BD:F2:8E:24:7D name=IF-EOIP-2011-QC28 remote-address=172.19.28.242 \
    tunnel-id=281
add keepalive=1s,3 local-address=172.19.29.241 loop-protect=off mac-address=\
    FE:DB:37:23:E7:21 name=IF-EOIP-2011-QC29 remote-address=172.19.29.242 \
    tunnel-id=291
add keepalive=1s,3 local-address=172.19.10.241 loop-protect=off mac-address=\
    FE:B1:C7:EE:93:91 name=IF-EOIP-SOB-QC10 remote-address=172.19.10.243 \
    tunnel-id=102
add keepalive=1s,3 local-address=172.19.11.241 loop-protect=off mac-address=\
    FE:4C:BC:30:54:BD name=IF-EOIP-SOB-QC11 remote-address=172.19.11.243 \
    tunnel-id=112
add keepalive=1s,3 local-address=172.19.12.241 loop-protect=off mac-address=\
    FE:93:BF:2E:34:8D name=IF-EOIP-SOB-QC12 remote-address=172.19.12.243 \
    tunnel-id=122
add keepalive=1s,3 local-address=172.19.14.241 loop-protect=off mac-address=\
    FE:A6:BE:AF:07:C1 name=IF-EOIP-SOB-QC14 remote-address=172.19.14.243 \
    tunnel-id=142
add keepalive=1s,3 local-address=172.19.15.241 loop-protect=off mac-address=\
    FE:76:76:A0:1E:60 name=IF-EOIP-SOB-QC15 remote-address=172.19.15.243 \
    tunnel-id=152
add keepalive=1s,3 local-address=172.19.16.241 loop-protect=off mac-address=\
    FE:15:79:D6:BE:CD name=IF-EOIP-SOB-QC16 remote-address=172.19.16.243 \
    tunnel-id=162
add keepalive=1s,3 local-address=172.19.17.241 loop-protect=off mac-address=\
    FE:6F:30:65:8D:82 name=IF-EOIP-SOB-QC17 remote-address=172.19.17.243 \
    tunnel-id=172
add keepalive=1s,3 local-address=172.19.18.241 loop-protect=off mac-address=\
    FE:52:C9:79:D0:77 name=IF-EOIP-SOB-QC18 remote-address=172.19.18.243 \
    tunnel-id=182
add keepalive=1s,3 local-address=172.19.19.241 loop-protect=off mac-address=\
    FE:93:38:54:1D:3B name=IF-EOIP-SOB-QC19 remote-address=172.19.19.243 \
    tunnel-id=192
add keepalive=1s,3 local-address=172.19.20.241 loop-protect=off mac-address=\
    FE:BE:DD:6D:0F:FE name=IF-EOIP-SOB-QC20 remote-address=172.19.20.243 \
    tunnel-id=202
add keepalive=1s,3 local-address=172.19.21.241 loop-protect=off mac-address=\
    FE:B0:D0:6E:4D:3F name=IF-EOIP-SOB-QC21 remote-address=172.19.21.243 \
    tunnel-id=212
add keepalive=1s,3 local-address=172.19.22.241 loop-protect=off mac-address=\
    FE:C8:E1:5F:CA:2A name=IF-EOIP-SOB-QC22 remote-address=172.19.22.243 \
    tunnel-id=222
add keepalive=1s,3 local-address=172.19.23.241 loop-protect=off mac-address=\
    FE:80:BC:B0:A2:BD name=IF-EOIP-SOB-QC23 remote-address=172.19.23.243 \
    tunnel-id=232
add keepalive=1s,3 local-address=172.19.24.241 loop-protect=off mac-address=\
    FE:7A:B9:28:9D:1D name=IF-EOIP-SOB-QC24 remote-address=172.19.24.243 \
    tunnel-id=242
add keepalive=1s,3 local-address=172.19.25.241 loop-protect=off mac-address=\
    FE:7B:C5:30:10:CD name=IF-EOIP-SOB-QC25 remote-address=172.19.25.243 \
    tunnel-id=252
add keepalive=1s,3 local-address=172.19.26.241 loop-protect=off mac-address=\
    FE:D7:01:56:CD:96 name=IF-EOIP-SOB-QC26 remote-address=172.19.26.243 \
    tunnel-id=262
add keepalive=1s,3 local-address=172.19.27.241 loop-protect=off mac-address=\
    FE:C5:EB:28:4F:D3 name=IF-EOIP-SOB-QC27 remote-address=172.19.27.243 \
    tunnel-id=272
add keepalive=1s,3 local-address=172.19.28.241 loop-protect=off mac-address=\
    FE:79:68:01:1E:98 name=IF-EOIP-SOB-QC28 remote-address=172.19.28.243 \
    tunnel-id=282
add keepalive=1s,3 local-address=172.19.29.241 loop-protect=off mac-address=\
    FE:D4:43:2F:0B:2D name=IF-EOIP-SOB-QC29 remote-address=172.19.29.243 \
    tunnel-id=292
...
add interface=BR_VLAN50 name=IF-VRRP-VLAN50 priority=20 vrid=0
...
add interface=IF-BOND-CISCO name=IF-VLAN1429-CCR2 vlan-id=1429
...
# UTILIDAD: IP flotante que se mueve automáticamente a un router de respaldo si el principal falla.
# SI FALTA: Corte de servicio manual necesario si el router principal muere.
add interface=IF-VLAN1701-FIBRA1-QC10 name=IF-VRRP-FIBRA1-QC10 priority=20
add interface=IF-VLAN1711-FIBRA1-QC11 name=IF-VRRP-FIBRA1-QC11 priority=20 \
    vrid=11
add interface=IF-VLAN1721-FIBRA1-QC12 name=IF-VRRP-FIBRA1-QC12 priority=20 \
    vrid=21
add interface=IF-VLAN1741-FIBRA1-QC14 name=IF-VRRP-FIBRA1-QC14 priority=20 \
    vrid=41
add interface=IF-VLAN1751-FIBRA1-QC15 name=IF-VRRP-FIBRA1-QC15 priority=20 \
    vrid=51
add interface=IF-VLAN1761-FIBRA1-QC16 name=IF-VRRP-FIBRA1-QC16 priority=20 \
    vrid=61
add interface=IF-VLAN1771-FIBRA1-QC17 name=IF-VRRP-FIBRA1-QC17 priority=20 \
    vrid=71
add interface=IF-VLAN1781-FIBRA1-QC18 name=IF-VRRP-FIBRA1-QC18 priority=20 \
    vrid=81
add interface=IF-VLAN1791-FIBRA1-QC19 name=IF-VRRP-FIBRA1-QC19 priority=20 \
    vrid=91
add interface=IF-VLAN1801-FIBRA1-QC20 name=IF-VRRP-FIBRA1-QC20 priority=20 \
    vrid=101
add interface=IF-VLAN1811-FIBRA1-QC21 name=IF-VRRP-FIBRA1-QC21 priority=20 \
    vrid=111
add interface=IF-VLAN1821-FIBRA1-QC22 name=IF-VRRP-FIBRA1-QC22 priority=20 \
    vrid=121
add interface=IF-VLAN1831-FIBRA1-QC23 name=IF-VRRP-FIBRA1-QC23 priority=20 \
    vrid=131
add interface=IF-VLAN1841-FIBRA1-QC24 name=IF-VRRP-FIBRA1-QC24 priority=20 \
    vrid=141
add interface=IF-VLAN1851-FIBRA1-QC25 name=IF-VRRP-FIBRA1-QC25 priority=20 \
    vrid=151
add interface=IF-VLAN1861-FIBRA1-QC26 name=IF-VRRP-FIBRA1-QC26 priority=20 \
    vrid=161
add interface=IF-VLAN1871-FIBRA1-QC27 name=IF-VRRP-FIBRA1-QC27 priority=20 \
    vrid=171
add interface=IF-VLAN1881-FIBRA1-QC28 name=IF-VRRP-FIBRA1-QC28 priority=20 \
    vrid=181
add interface=IF-VLAN1891-FIBRA1-QC29 name=IF-VRRP-FIBRA1-QC29 priority=20 \
    vrid=191
add interface=IF-VLAN1702-FIBRA2-QC10 name=IF-VRRP-FIBRA2-QC10 priority=20 \
    vrid=2
add interface=IF-VLAN1712-FIBRA2-QC11 name=IF-VRRP-FIBRA2-QC11 priority=20 \
    vrid=12
add interface=IF-VLAN1722-FIBRA2-QC12 name=IF-VRRP-FIBRA2-QC12 priority=20 \
    vrid=22
add interface=IF-VLAN1742-FIBRA2-QC14 name=IF-VRRP-FIBRA2-QC14 priority=20 \
    vrid=42
add interface=IF-VLAN1752-FIBRA2-QC15 name=IF-VRRP-FIBRA2-QC15 priority=20 \
    vrid=52
add interface=IF-VLAN1762-FIBRA2-QC16 name=IF-VRRP-FIBRA2-QC16 priority=20 \
    vrid=62
add interface=IF-VLAN1772-FIBRA2-QC17 name=IF-VRRP-FIBRA2-QC17 priority=20 \
    vrid=72
add interface=IF-VLAN1782-FIBRA2-QC18 name=IF-VRRP-FIBRA2-QC18 priority=20 \
    vrid=82
add interface=IF-VLAN1792-FIBRA2-QC19 name=IF-VRRP-FIBRA2-QC19 priority=20 \
    vrid=92
add interface=IF-VLAN1802-FIBRA2-QC20 name=IF-VRRP-FIBRA2-QC20 priority=20 \
    vrid=102
add interface=IF-VLAN1812-FIBRA2-QC21 name=IF-VRRP-FIBRA2-QC21 priority=20 \
    vrid=112
add interface=IF-VLAN1822-FIBRA2-QC22 name=IF-VRRP-FIBRA2-QC22 priority=20 \
    vrid=122
add interface=IF-VLAN1832-FIBRA2-QC23 name=IF-VRRP-FIBRA2-QC23 priority=20 \
    vrid=132
add interface=IF-VLAN1842-FIBRA2-QC24 name=IF-VRRP-FIBRA2-QC24 priority=20 \
    vrid=142
add interface=IF-VLAN1852-FIBRA2-QC25 name=IF-VRRP-FIBRA2-QC25 priority=20 \
    vrid=152
add interface=IF-VLAN1862-FIBRA2-QC26 name=IF-VRRP-FIBRA2-QC26 priority=20 \
    vrid=162
add interface=IF-VLAN1872-FIBRA2-QC27 name=IF-VRRP-FIBRA2-QC27 priority=20 \
    vrid=172
add interface=IF-VLAN1882-FIBRA2-QC28 name=IF-VRRP-FIBRA2-QC28 priority=20 \
    vrid=182
add interface=IF-VLAN1892-FIBRA2-QC29 name=IF-VRRP-FIBRA2-QC29 priority=20 \
    vrid=192
add interface=IF-VLAN1703-FIBRA3-QC10 name=IF-VRRP-FIBRA3-QC10 priority=20 \
    vrid=3
add interface=IF-VLAN1713-FIBRA3-QC11 name=IF-VRRP-FIBRA3-QC11 priority=20 \
    vrid=13
add interface=IF-VLAN1723-FIBRA3-QC12 name=IF-VRRP-FIBRA3-QC12 priority=20 \
    vrid=23
add interface=IF-VLAN1743-FIBRA3-QC14 name=IF-VRRP-FIBRA3-QC14 priority=20 \
    vrid=43
add interface=IF-VLAN1753-FIBRA3-QC15 name=IF-VRRP-FIBRA3-QC15 priority=20 \
    vrid=53
add interface=IF-VLAN1763-FIBRA3-QC16 name=IF-VRRP-FIBRA3-QC16 priority=20 \
    vrid=63
add interface=IF-VLAN1773-FIBRA3-QC17 name=IF-VRRP-FIBRA3-QC17 priority=20 \
    vrid=73
add interface=IF-VLAN1783-FIBRA3-QC18 name=IF-VRRP-FIBRA3-QC18 priority=20 \
    vrid=83
add interface=IF-VLAN1793-FIBRA3-QC19 name=IF-VRRP-FIBRA3-QC19 priority=20 \
    vrid=93
add interface=IF-VLAN1803-FIBRA3-QC20 name=IF-VRRP-FIBRA3-QC20 priority=20 \
    vrid=103
add interface=IF-VLAN1813-FIBRA3-QC21 name=IF-VRRP-FIBRA3-QC21 priority=20 \
    vrid=113
add interface=IF-VLAN1823-FIBRA3-QC22 name=IF-VRRP-FIBRA3-QC22 priority=20 \
    vrid=123
add interface=IF-VLAN1833-FIBRA3-QC23 name=IF-VRRP-FIBRA3-QC23 priority=20 \
    vrid=133
add interface=IF-VLAN1843-FIBRA3-QC24 name=IF-VRRP-FIBRA3-QC24 priority=20 \
    vrid=143
add interface=IF-VLAN1853-FIBRA3-QC25 name=IF-VRRP-FIBRA3-QC25 priority=20 \
    vrid=153
add interface=IF-VLAN1863-FIBRA3-QC26 name=IF-VRRP-FIBRA3-QC26 priority=20 \
    vrid=163
add interface=IF-VLAN1873-FIBRA3-QC27 name=IF-VRRP-FIBRA3-QC27 priority=20 \
    vrid=173
add interface=IF-VLAN1883-FIBRA3-QC28 name=IF-VRRP-FIBRA3-QC28 priority=20 \
    vrid=183
add interface=IF-VLAN1893-FIBRA3-QC29 name=IF-VRRP-FIBRA3-QC29 priority=20 \
    vrid=193
add interface=IF-VLAN53-CISCO-LTE name=IF-VRRP-LTE priority=20 vrid=6
add interface=IF-VLAN1700-WIFI-QC10 name=IF-VRRP-WIFI-QC10 priority=20 vrid=5
add interface=IF-VLAN1710-WIFI-QC11 name=IF-VRRP-WIFI-QC11 priority=20 vrid=\
    15
add interface=IF-VLAN1720-WIFI-QC12 name=IF-VRRP-WIFI-QC12 priority=20 vrid=\
    25
add interface=IF-VLAN1740-WIFI-QC14 name=IF-VRRP-WIFI-QC14 priority=20 vrid=\
    45
add interface=IF-VLAN1750-WIFI-QC15 name=IF-VRRP-WIFI-QC15 priority=20 vrid=\
    55
add interface=IF-VLAN1760-WIFI-QC16 name=IF-VRRP-WIFI-QC16 priority=20 vrid=\
    65
add interface=IF-VLAN1770-WIFI-QC17 name=IF-VRRP-WIFI-QC17 priority=20 vrid=\
    75
add interface=IF-VLAN1780-WIFI-QC18 name=IF-VRRP-WIFI-QC18 priority=20 vrid=\
    85
add interface=IF-VLAN1790-WIFI-QC19 name=IF-VRRP-WIFI-QC19 priority=20 vrid=\
    95
add interface=IF-VLAN1800-WIFI-QC20 name=IF-VRRP-WIFI-QC20 priority=20 vrid=\
    105
add interface=IF-VLAN1810-WIFI-QC21 name=IF-VRRP-WIFI-QC21 priority=20 vrid=\
    115
add interface=IF-VLAN1820-WIFI-QC22 name=IF-VRRP-WIFI-QC22 priority=20 vrid=\
    125
add interface=IF-VLAN1830-WIFI-QC23 name=IF-VRRP-WIFI-QC23 priority=20 vrid=\
    135
add interface=IF-VLAN1840-WIFI-QC24 name=IF-VRRP-WIFI-QC24 priority=20 vrid=\
    145
add interface=IF-VLAN1850-WIFI-QC25 name=IF-VRRP-WIFI-QC25 priority=20 vrid=\
    155
add interface=IF-VLAN1860-WIFI-QC26 name=IF-VRRP-WIFI-QC26 priority=20 vrid=\
    165
add interface=IF-VLAN1870-WIFI-QC27 name=IF-VRRP-WIFI-QC27 priority=20 vrid=\
    175
add interface=IF-VLAN1880-WIFI-QC28 name=IF-VRRP-WIFI-QC28 priority=20 vrid=\
    185
add interface=IF-VLAN1890-WIFI-QC29 name=IF-VRRP-WIFI-QC29 priority=20 vrid=\
    195
...
add address=172.17.1.202/24 interface=BR_VLAN50 network=172.17.1.0
...
add address=172.19.10.178/30 interface=IF-VLAN1701-FIBRA1-QC10 network=\
    172.19.10.176
add address=172.19.10.182/30 interface=IF-VLAN1702-FIBRA2-QC10 network=\
    172.19.10.180
add address=172.19.10.186/30 interface=IF-VLAN1703-FIBRA3-QC10 network=\
    172.19.10.184
add address=172.19.10.190/30 interface=IF-VLAN1704-WIFI-SOB-QC10 network=\
    172.19.10.188
add address=172.19.10.194/30 interface=IF-VLAN1700-WIFI-QC10 network=\
    172.19.10.192
add address=10.34.183.233/28 interface=IF-VLAN53-CISCO-LTE network=\
    10.34.183.224
add address=172.19.11.178/30 interface=IF-VLAN1711-FIBRA1-QC11 network=\
    172.19.11.176
add address=172.19.11.182/30 interface=IF-VLAN1712-FIBRA2-QC11 network=\
    172.19.11.180
add address=172.19.11.186/30 interface=IF-VLAN1713-FIBRA3-QC11 network=\
    172.19.11.184
add address=172.19.11.190/30 interface=IF-VLAN1714-WIFI-SOB-QC11 network=\
    172.19.11.188
add address=172.19.11.194/30 interface=IF-VLAN1710-WIFI-QC11 network=\
    172.19.11.192
...
add address=172.19.12.182/30 interface=IF-VLAN1722-FIBRA2-QC12 network=\
    172.19.12.180
...
add address=172.19.12.178/30 interface=IF-VLAN1721-FIBRA1-QC12 network=\
    172.19.12.176
add address=172.19.12.190/30 interface=IF-VLAN1724-WIFI-SOB-QC12 network=\
    172.19.12.188
add address=172.19.12.194/30 interface=IF-VLAN1720-WIFI-QC12 network=\
    172.19.12.192
add address=172.19.12.186/30 interface=IF-VLAN1723-FIBRA3-QC12 network=\
    172.19.12.184
...
add address=172.19.28.178/30 interface=IF-VLAN1881-FIBRA1-QC28 network=\
    172.19.28.176
add address=172.19.28.182/30 interface=IF-VLAN1882-FIBRA2-QC28 network=\
    172.19.28.180
add address=172.19.28.186/30 interface=IF-VLAN1883-FIBRA3-QC28 network=\
    172.19.28.184
add address=172.19.28.190/30 interface=IF-VLAN1884-WIFI-SOB-QC28 network=\
    172.19.28.188
add address=172.19.28.194/30 interface=IF-VLAN1880-WIFI-QC28 network=\
    172.19.28.192
...
add address=172.19.29.178/30 interface=IF-VLAN1891-FIBRA1-QC29 network=\
    172.19.29.176
add address=172.19.29.182/30 interface=IF-VLAN1892-FIBRA2-QC29 network=\
    172.19.29.180
add address=172.19.29.186/30 interface=IF-VLAN1893-FIBRA3-QC29 network=\
    172.19.29.184
add address=172.19.29.190/30 interface=IF-VLAN1894-WIFI-SOB-QC29 network=\
    172.19.29.188
add address=172.19.29.194/30 interface=IF-VLAN1890-WIFI-QC29 network=\
    172.19.29.192
...
add address=172.19.26.178/30 interface=IF-VLAN1861-FIBRA1-QC26 network=\
    172.19.26.176
add address=172.19.26.182/30 interface=IF-VLAN1862-FIBRA2-QC26 network=\
    172.19.26.180
add address=172.19.26.186/30 interface=IF-VLAN1863-FIBRA3-QC26 network=\
    172.19.26.184
add address=172.19.26.190/30 interface=IF-VLAN1864-WIFI-SOB-QC26 network=\
    172.19.26.188
add address=172.19.26.194/30 interface=IF-VLAN1860-WIFI-QC26 network=\
    172.19.26.192
...
add address=172.19.14.178/30 interface=IF-VLAN1741-FIBRA1-QC14 network=\
    172.19.14.176
add address=172.19.14.182/30 interface=IF-VLAN1742-FIBRA2-QC14 network=\
    172.19.14.180
add address=172.19.14.186/30 interface=IF-VLAN1743-FIBRA3-QC14 network=\
    172.19.14.184
add address=172.19.14.190/30 interface=IF-VLAN1744-WIFI-SOB-QC14 network=\
    172.19.14.188
add address=172.19.14.194/30 interface=IF-VLAN1740-WIFI-QC14 network=\
    172.19.14.192
...
add address=172.19.22.178/30 interface=IF-VLAN1821-FIBRA1-QC22 network=\
    172.19.22.176
add address=172.19.22.182/30 interface=IF-VLAN1822-FIBRA2-QC22 network=\
    172.19.22.180
add address=172.19.22.186/30 interface=IF-VLAN1823-FIBRA3-QC22 network=\
    172.19.22.184
add address=172.19.22.190/30 interface=IF-VLAN1824-WIFI-SOB-QC22 network=\
    172.19.22.188
add address=172.19.22.194/30 interface=IF-VLAN1820-WIFI-QC22 network=\
    172.19.22.192
...
add address=172.19.21.178/30 interface=IF-VLAN1811-FIBRA1-QC21 network=\
    172.19.21.176
add address=172.19.21.182/30 interface=IF-VLAN1812-FIBRA2-QC21 network=\
    172.19.21.180
add address=172.19.21.186/30 interface=IF-VLAN1813-FIBRA3-QC21 network=\
    172.19.21.184
add address=172.19.21.190/30 interface=IF-VLAN1814-WIFI-SOB-QC21 network=\
    172.19.21.188
add address=172.19.21.194/30 interface=IF-VLAN1810-WIFI-QC21 network=\
    172.19.21.192
...
add address=172.19.18.178/30 interface=IF-VLAN1781-FIBRA1-QC18 network=\
    172.19.18.176
add address=172.19.18.182/30 interface=IF-VLAN1782-FIBRA2-QC18 network=\
    172.19.18.180
add address=172.19.18.186/30 interface=IF-VLAN1783-FIBRA3-QC18 network=\
    172.19.18.184
add address=172.19.18.190/30 interface=IF-VLAN1784-WIFI-SOB-QC18 network=\
    172.19.18.188
add address=172.19.18.194/30 interface=IF-VLAN1780-WIFI-QC18 network=\
    172.19.18.192
...
add address=172.19.17.178/30 interface=IF-VLAN1771-FIBRA1-QC17 network=\
    172.19.17.176
add address=172.19.17.182/30 interface=IF-VLAN1772-FIBRA2-QC17 network=\
    172.19.17.180
add address=172.19.17.186/30 interface=IF-VLAN1773-FIBRA3-QC17 network=\
    172.19.17.184
add address=172.19.17.190/30 interface=IF-VLAN1774-WIFI-SOB-QC17 network=\
    172.19.17.188
add address=172.19.17.194/30 interface=IF-VLAN1770-WIFI-QC17 network=\
    172.19.17.192
...
add address=172.19.19.178/30 interface=IF-VLAN1791-FIBRA1-QC19 network=\
    172.19.19.176
add address=172.19.19.182/30 interface=IF-VLAN1792-FIBRA2-QC19 network=\
    172.19.19.180
add address=172.19.19.186/30 interface=IF-VLAN1793-FIBRA3-QC19 network=\
    172.19.19.184
add address=172.19.19.190/30 interface=IF-VLAN1794-WIFI-SOB-QC19 network=\
    172.19.19.188
add address=172.19.19.194/30 interface=IF-VLAN1790-WIFI-QC19 network=\
    172.19.19.192
...
add address=172.19.25.178/30 interface=IF-VLAN1851-FIBRA1-QC25 network=\
    172.19.25.176
add address=172.19.25.182/30 interface=IF-VLAN1852-FIBRA2-QC25 network=\
    172.19.25.180
add address=172.19.25.186/30 interface=IF-VLAN1853-FIBRA3-QC25 network=\
    172.19.25.184
add address=172.19.25.190/30 interface=IF-VLAN1854-WIFI-SOB-QC25 network=\
    172.19.25.188
add address=172.19.25.194/30 interface=IF-VLAN1850-WIFI-QC25 network=\
    172.19.25.192
...
add address=172.19.15.178/30 interface=IF-VLAN1751-FIBRA1-QC15 network=\
    172.19.15.176
add address=172.19.15.182/30 interface=IF-VLAN1752-FIBRA2-QC15 network=\
    172.19.15.180
add address=172.19.15.186/30 interface=IF-VLAN1753-FIBRA3-QC15 network=\
    172.19.15.184
add address=172.19.15.190/30 interface=IF-VLAN1754-WIFI-SOB-QC15 network=\
    172.19.15.188
add address=172.19.15.194/30 interface=IF-VLAN1750-WIFI-QC15 network=\
    172.19.15.192
...
add address=172.19.16.178/30 interface=IF-VLAN1761-FIBRA1-QC16 network=\
    172.19.16.176
add address=172.19.16.182/30 interface=IF-VLAN1762-FIBRA2-QC16 network=\
    172.19.16.180
add address=172.19.16.186/30 interface=IF-VLAN1763-FIBRA3-QC16 network=\
    172.19.16.184
add address=172.19.16.190/30 interface=IF-VLAN1764-WIFI-SOB-QC16 network=\
    172.19.16.188
add address=172.19.16.194/30 interface=IF-VLAN1760-WIFI-QC16 network=\
    172.19.16.192
...
add address=172.19.27.178/30 interface=IF-VLAN1871-FIBRA1-QC27 network=\
    172.19.27.176
add address=172.19.27.182/30 interface=IF-VLAN1872-FIBRA2-QC27 network=\
    172.19.27.180
add address=172.19.27.186/30 interface=IF-VLAN1873-FIBRA3-QC27 network=\
    172.19.27.184
add address=172.19.27.190/30 interface=IF-VLAN1874-WIFI-SOB-QC27 network=\
    172.19.27.188
add address=172.19.27.194/30 interface=IF-VLAN1870-WIFI-QC27 network=\
    172.19.27.192
...
add address=172.19.20.178/30 interface=IF-VLAN1801-FIBRA1-QC20 network=\
    172.19.20.176
add address=172.19.20.182/30 interface=IF-VLAN1802-FIBRA2-QC20 network=\
    172.19.20.180
add address=172.19.20.186/30 interface=IF-VLAN1803-FIBRA3-QC20 network=\
    172.19.20.184
add address=172.19.20.190/30 interface=IF-VLAN1804-WIFI-SOB-QC20 network=\
    172.19.20.188
add address=172.19.20.194/30 interface=IF-VLAN1800-WIFI-QC20 network=\
    172.19.20.192
...
add address=172.19.23.178/30 interface=IF-VLAN1831-FIBRA1-QC23 network=\
    172.19.23.176
add address=172.19.23.182/30 interface=IF-VLAN1832-FIBRA2-QC23 network=\
    172.19.23.180
add address=172.19.23.186/30 interface=IF-VLAN1833-FIBRA3-QC23 network=\
    172.19.23.184
add address=172.19.23.190/30 interface=IF-VLAN1834-WIFI-SOB-QC23 network=\
    172.19.23.188
add address=172.19.23.194/30 interface=IF-VLAN1830-WIFI-QC23 network=\
    172.19.23.192
...
add address=172.19.24.178/30 interface=IF-VLAN1841-FIBRA1-QC24 network=\
    172.19.24.176
add address=172.19.24.182/30 interface=IF-VLAN1842-FIBRA2-QC24 network=\
    172.19.24.180
add address=172.19.24.186/30 interface=IF-VLAN1843-FIBRA3-QC24 network=\
    172.19.24.184
add address=172.19.24.190/30 interface=IF-VLAN1844-WIFI-SOB-QC24 network=\
    172.19.24.188
add address=172.19.24.194/30 interface=IF-VLAN1840-WIFI-QC24 network=\
    172.19.24.192
...
################################################################################
##########   SECCIÓN: /IP FIREWALL ADDRESS-LIST   ##########
################################################################################
...
add action=accept chain=output comment=ACCEPT_REPLY_SNM out-interface-list=\
...
################################################################################
##########   SECCIÓN: /IP FIREWALL SERVICE-PORT   ##########
################################################################################
...
################################################################################
##########   SECCIÓN: /ROUTING BGP CONNECTION   ##########
################################################################################
...
set enabled=yes engine-id-suffix=QCCLOUDCORE2 src-address=172.17.1.202 \
...
################################################################################
##########   SECCIÓN: /SYSTEM NTP CLIENT SERVERS   ##########
################################################################################
...
################################################################################
##########   SECCIÓN: /SYSTEM ROUTERBOARD SETTINGS   ##########
################################################################################
...
################################################################################
##########   SECCIÓN: /TOOL MAC-SERVER MAC-WINBOX   ##########
################################################################################
...
# 1. Verificar consistencia de zonas horarias en NTP para logs unificados.
# 2. Revisar versiones de RouterBOOT vs RouterOS.
# 3. Validar listas de acceso de N4 regularmente.
