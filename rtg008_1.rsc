# 2026-01-27 12:50:46 by RouterOS 7.20.4
# software id = 4IQC-B9M2
#
# model = RBMetalG-52SHPacn
# serial number = HJX0AGAXK55
/interface eoip
...
add dont-require-permissions=no name=vlan9Control owner=ideltec policy=\
    ...
    while (true) do={\r\
    \n    :delay 5\r\
    \n    :local eoipControl [/interface/eoip/get IF-EOIP-CRS value-name=runni\
    ng]\r\
    \n    :local mirrorControl [/tool/netwatch/get mirror value-name=status]\r\
    \n    :local vlanStatus [/interface/vrrp/get IF-VRRP-VLAN9-OT value-name=d\
    isabled]\r\
    \n    :if ((\$eoipControl = false) && (\$mirrorControl = \"up\")) do={\r\
    \n        :if (\$vlanStatus = false) do={\r\
    \n            /interface/vrrp/set IF-VRRP-VLAN9-OT disabled=yes\r\
    \n        }\r\
    \n    }\r\
    \n    :if ((\$mirrorControl = \"down\") || (\$eoipControl = true)) do={\r\
    \n        :if (\$vlanStatus = true) do={\r\
    \n            /interface/vrrp/set IF-VRRP-VLAN9-OT disabled=no\r\
    \n        }\r\
    \n    }\r\
    \n}"
